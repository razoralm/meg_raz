...
TFCEinput_stc = path + 'target/data_for_TFCE/labeled/cos/{0}_{1}_{2}_integ5_{3}-{4}.stc' 
...
for subject in subjects:
	...
	TFCE_files.append(TFCEinput_stc.format(subject, "cosS1W2", time_lbl, lbl_name,"lh"))
	TFCE_files.append(TFCEinput_stc.format(subject, "cosS1W2", time_lbl, lbl_name, "rh"))
	TFCE_files.append(TFCEinput_stc.format(subject, "cosS1D2", time_lbl, lbl_name, "lh"))
	TFCE_files.append(TFCEinput_stc.format(subject, "cosS1D2", time_lbl, lbl_name, "rh"))
...
## set output stc names (for fixed params in mesh-time mode) 
                                ...
                                #3dTFCE_144_217ms_integ5_presylvian_e1h2n100-lh
                                #type_{time_interval}_integ_{label}_param-e{e}param-h{h}n_perm{n_perm}-{hemisphere}.stc
output_lh = output_meshtime_stc.format('cosS1W2_vs_cosS1D2', time_lbl, lbl_name, e, h, n_perm, "lh")	
output_rh = output_meshtime_stc.format('cosS1W2_vs_cosS1D2', time_lbl, lbl_name, e, h, n_perm, "rh")	
