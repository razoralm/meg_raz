...
save_result_format = "/net/server/data/programs/razoral/platon_pmwords/target/data_for_TFCE/normalized_{}_{}_{}_integ5" 
...
for subject_idx, subject in enumerate(subjects):
	...
	dw_stc = mne.SourceEstimate(dw/dw_max, vertices = stc1.vertices, tmin = stc1.tmin, tstep = stc1.tstep)
	...
	dd_stc = mne.SourceEstimate(dd/dd_max, vertices = stc1.vertices, tmin = stc1.tmin, tstep = stc1.tstep)
