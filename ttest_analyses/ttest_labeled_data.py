...
ttest_result = '/net/server/data/programs/razoral/platon_pmwords/target/manual_ttest/{}_sub24_integ5_dW_vs_dD_{}_{}'
...
print('\n')
frame = numpy.zeros(p_val_integ.shape)

p_val_data = numpy.array([p_val_integ, frame])
print(p_val_data.T)

p_val_stc = mne.SourceEstimate(p_val_data.T, vertices = stc_test.vertices, tmin = 0.144, tstep = 0.073)
p_val_stc.save(ttest_result.format("p-val", time_lbl, lbl_name))
